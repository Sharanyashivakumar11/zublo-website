...
// ========== SMS CONFIGURATION ==========
// Email-to-SMS (Free - uses carrier email-to-SMS gateway)
...
const SMS_EMAIL_ADDRESS = '2132680491@tmomail.net'; // T-Mobile format: number@tmomail.net
...
/**
 * Sends SMS notification via email-to-SMS gateway
 */
